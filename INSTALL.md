...
| `bash: start.sh: No such file or directory`, exit 127 | Le script d'installation est mort avant d'écrire `start.sh`. La cause réelle est plus haut dans le log d'installation, pas dans la console. |
